  ...
  return (
    <div className="flex w-full h-[100vh] justify-center items-center relative">
      <div className="w-[790px] h-[540px] bg-[#3E3F43] rounded-xl relative overflow-hidden -z-0">
        <div className="flex flex-col px-24 py-10 text-white">
            ...
            <div className="flex flex-col font-bold text-xl">
              <div className="flex flex-col mb-8">
                ...
                <input
                  ...
                  className="bg-[#1C1C26] h-12 rounded-xl px-3 font-normal"
                />
              </div>
              ...
              <Link
                href="#"
                className="font-normal text-[#2B74FF] mb-6 hover:underline"
              >
                Esqueceu sua senha?
              </Link>
        ...
        <div className="w-[229.85px] h-[838.28px] origin-top-left rotate-[25deg] bg-[rgba(29,31,40,0.15)] absolute -top-[200px] right-20 -z-10"></div>
      </div>
